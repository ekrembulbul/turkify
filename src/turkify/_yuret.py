# -*- coding: utf-8 -*-
#
# === VENDOR EDİLMİŞTİR — ELLE DÜZENLEMEYİN ===
# Türkçe deasciifier (diakritik restorasyon) — Tier 1 deterministik çekirdek.
# Algoritma: Deniz Yüret. Python uygulaması: Emre Sevinç.
# Kaynak: https://github.com/emres/turkish-deasciifier (turkish/deasciifier.py)
# Lisans: Public Domain (PyPI 'Turkish-Deasciifier' meta verisine göre).
# Vendor tarihi: 2026-05-21. Pattern tablosu korpus türevli; algoritma Python 3 uyumlu.
# Temiz arayüz için bkz. turkify/deasciifier.py sarmalayıcısı.
#
